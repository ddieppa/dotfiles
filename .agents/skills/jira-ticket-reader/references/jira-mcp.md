<<<<<<< D:/src/work/metrc/metrc.webapp/.agents/skills/jira-ticket-reader/references/jira-mcp.md
# MCP Reference
...
Download attachments from an issue to local filesystem. **Preferred method for retrieving images and files.**

**Parameters:**

- `issue_key` (required): Issue key (e.g., "MCA-405")
...
jira_download_attachments({
  issue_key: "MCA-405",
  output_dir: "personal/tasks/MCA-405/images",
});
```

**Usage Notes:**

- Only create `images/` folder if this tool succeeds and returns downloaded files
- Returns list of downloaded file paths on success
- Use for embedding screenshots and diagrams in ticket documentation
- Supports all attachment types (images, PDFs, documents)

**Source:** Atlassian Rovo MCP Server, sooperset/mcp-atlassian
    ...
    fields: {
      ...
      customfield_11828: {
        ...
        content: [
          {
            type: "paragraph",
            content: [{ type: "text", text: "Custom field value" }],
          },
        ],
      },
    },
...
const reviewTransition = transitions.transitions.find(
  (t) => t.name === "Review Code" || t.to.name === "In Review",
);
...
>>>>>>> C:/Users/ddiep/.windsurf/worktrees/metrc.webapp/metrc.webapp-41978689/.agents/skills/jira-ticket-reader/references/jira-mcp.md
